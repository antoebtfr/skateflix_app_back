...
export class AuthService {
    ...
    async signIn(email: string, password: string){
        ...
        const user = await this.userRepo.findOne({where: { email }, select: ["id", "email", "password", "isActive", "firstname", "surname", "nickname", "age", "country", "region", "profilPicture", "isPremium", "isAdmin"]})
        console.log(user);
